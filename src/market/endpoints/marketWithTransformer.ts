...
export const getQuoteHomePageQueryKey = () => [`/quote/homePage.do`] as const;

export const getQuoteHomePageQueryOptions = <
...
}): UseQueryOptions<Awaited<ReturnType<typeof quoteHomePage>>, TError, TData> & {
  queryKey: QueryKey;
} => {
...
>(options?: {
  ...
  const queryOptions = getQuoteHomePageQueryOptions(options);
...
export const getQuoteRealQueryKey = (quoteRealBody: QuoteRealBody) =>
  [`/quote/real.do`, quoteRealBody] as const;

export const getQuoteRealQueryOptions = <
...
): UseQueryOptions<Awaited<ReturnType<typeof quoteReal>>, TError, TData> & {
  queryKey: QueryKey;
} => {
  const { query: queryOptions } = options ?? {};
...
export const getKlineQueryKey = (klineBody: KlineBody) => [`/quote/kline.do`, klineBody] as const;

export const getKlineQueryOptions = <
  TData = Awaited<ReturnType<typeof kline>>,
  TError = ErrorType<unknown>,
>(
  klineBody: KlineBody,
  options?: { query?: UseQueryOptions<Awaited<ReturnType<typeof kline>>, TError, TData> },
): UseQueryOptions<Awaited<ReturnType<typeof kline>>, TError, TData> & { queryKey: QueryKey } => {
  const { query: queryOptions } = options ?? {};
...
export const useKline = <TData = Awaited<ReturnType<typeof kline>>, TError = ErrorType<unknown>>(
  ...
  const queryOptions = getKlineQueryOptions(klineBody, options);
...
export const getGetMinuteLineQueryKey = (getMinuteLineBody: GetMinuteLineBody) =>
  [`/quote/getMinuteLine.do`, getMinuteLineBody] as const;

export const getGetMinuteLineQueryOptions = <
...
): UseQueryOptions<Awaited<ReturnType<typeof getMinuteLine>>, TError, TData> & {
  queryKey: QueryKey;
} => {
  const { query: queryOptions } = options ?? {};
...
>(
  ...
  const queryOptions = getGetMinuteLineQueryOptions(getMinuteLineBody, options);
...
export const getMarketDataQueryKey = (marketDataBody: MarketDataBody) =>
  [`/quote/marketData.do`, marketDataBody] as const;

export const getMarketDataQueryOptions = <
...
): UseQueryOptions<Awaited<ReturnType<typeof marketData>>, TError, TData> & {
  queryKey: QueryKey;
} => {
  const { query: queryOptions } = options ?? {};
...
>(
  ...
  const queryOptions = getMarketDataQueryOptions(marketDataBody, options);
