...
export const getFindPaymentOptionListQueryKey = () =>
  [`/otc/payment/findPaymentOptionList.do`] as const;

export const getFindPaymentOptionListQueryOptions = <
...
}): UseQueryOptions<Awaited<ReturnType<typeof findPaymentOptionList>>, TError, TData> & {
  queryKey: QueryKey;
} => {
...
>(options?: {
  ...
  const queryOptions = getFindPaymentOptionListQueryOptions(options);
 ...
 * http發送文字聊天
 */
export const sendImage = (sendImageBody: SendImageBody) => {
  return customInstance<CommonResponse>({
    url: `/chat/sendImage.do`,
    method: 'post',
    headers: { 'Content-Type': 'application/json' },
    data: sendImageBody,
  });
...
export type SendImageMutationResult = NonNullable<Awaited<ReturnType<typeof sendImage>>>;
export type SendImageMutationBody = SendImageBody;
export type SendImageMutationError = ErrorType<unknown>;

export const useSendImage = <TError = ErrorType<unknown>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof sendImage>>,
    TError,
    { data: SendImageBody },
  ...
  const mutationOptions = getSendImageMutationOptions(options);
...
>(options?: {
  ...
  const queryOptions = getIdentityGetQueryOptions(options);
